...
node1.addService(pg.Execute(shell="sh", command="sudo apt-get update && sudo apt-get install libxml2-dev pkg-config && sudo git -C /root/ clone https://gitlab.flux.utah.edu/amaricq/SLANG-probed.git")) 
